...
pyautogui.click(x = 464, y = 396)

# escrever o seu email
pyautogui.write("j072.victors@gmail.com")
pyautogui.press("tab") # passando pro próximo campo
pyautogui.write("1234546789")
pyautogui.click(x = 630, y = 546) # clique no botão de login
time.sleep(3)
